...
public class AllMembers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AllMembers = new rojeru_san.complementos.RSTableMetro();
        ...
        AllMembers.setColorBackgoundHead(new java.awt.Color(255, 255, 204));
        AllMembers.setColorBordeFilas(new java.awt.Color(204, 204, 204));
        AllMembers.setColorBordeHead(new java.awt.Color(204, 204, 204));
        AllMembers.setColorFilasBackgound1(new java.awt.Color(204, 204, 204));
        AllMembers.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        AllMembers.setColorFilasForeground1(new java.awt.Color(0, 0, 0));
        AllMembers.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        AllMembers.setColorForegroundHead(new java.awt.Color(51, 51, 51));
        AllMembers.setColorSelBackgound(new java.awt.Color(51, 153, 255));
        AllMembers.setFuenteFilas(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        AllMembers.setFuenteFilasSelect(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        AllMembers.setFuenteHead(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        AllMembers.setGridColor(new java.awt.Color(153, 153, 153));
        AllMembers.setIntercellSpacing(new java.awt.Dimension(0, 0));
        AllMembers.setRowHeight(28);
        ...
        jLabel1.setText("MemberID OR Name");
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        try{
            conn = Javaconnect.ConnecrDB();
            String sql = "SELECT `mid` AS MemberID, `fullname` AS FullName, `initialname` AS NameWithInitial, `dob` AS DOB,  `nic` AS NIC, `phoneno` AS PhoneNo, `job` AS Proffesion, `address` AS Address FROM `member` WHERE fullname LIKE  '%"+txtSearch.getText()+"%' OR mid = '"+txtSearch.getText()+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            AllMembers.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
    ...
    private void tableLoard(){
        ...
        try{
            conn = Javaconnect.ConnecrDB();
            String sql = "SELECT `mid` AS MemberID, `fullname` AS FullName, `initialname` AS NameWithInitial, `dob` AS DOB, `nic` AS NIC, `phoneno` AS PhoneNo, `job` AS Proffesion, `address` AS Address FROM `member`";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            AllMembers.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
    ...
    private rojeru_san.complementos.RSTableMetro AllMembers;
