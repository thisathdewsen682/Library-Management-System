...
public class AllIssuedBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonHover6.setText("Arrived Members Count");
        ...
        rSButtonHover7.setText("Issued Book Count");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(rSButtonHover7, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(rSButtonHover6, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(iid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(rSButtonHover6, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(rSButtonHover7, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(22, 22, 22))
        );
    ...
    private void rSButtonHover6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover6ActionPerformed
        ...
        if(FDate.length()>0 &&  TDate.isEmpty()){
            ...
            try{
                conn = Javaconnect.ConnecrDB();
                String sql = "SELECT COUNT( DISTINCT mid) as Members_Arrived FROM issue WHERE i_date = '"+FDate+"'";
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                AllIssuedBooks.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
                countIssue();
            ...
            try {
                ...
                try{
                conn = Javaconnect.ConnecrDB();
                String sql = "SELECT COUNT( DISTINCT mid) as Members_Arrived FROM issue WHERE i_date BETWEEN '"+FDate+"' AND '"+TDate+"'";
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                AllIssuedBooks.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
                countIssue();
    ...
    private void rSButtonHover7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover7ActionPerformed
        ...
        if(FDate.length()>0 &&  TDate.isEmpty()){
            ...
            try{
                conn = Javaconnect.ConnecrDB();
                String sql = "SELECT cat_no AS CategorieNo,COUNT(DISTINCT mid) AS Book_Count FROM (SELECT * FROM issue WHERE i_date = '"+FDate+"')as D GROUP BY cat_no ORDER BY cat_no ASC";
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                AllIssuedBooks.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
                countIssue();
            ...
            try {
                ...
                try{
                conn = Javaconnect.ConnecrDB();
                String sql = "SELECT cat_no AS CategorieNo,COUNT(iid) AS Book_Count FROM (SELECT * FROM issue WHERE i_date BETWEEN '"+FDate+"' AND '"+TDate+"') as D GROUP BY cat_no ORDER BY cat_no ASC;";
                pst = conn.prepareStatement(sql);
                rs = pst.executeQuery();
                AllIssuedBooks.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
                countIssue();
